...
| `[indicator].talk_threshold` | `250` | Raw input meter level that counts as talking (0–4095 = silence to full scale). The settings dialog offers Low/Medium/High presets (500/250/100); set any other value here directly |
